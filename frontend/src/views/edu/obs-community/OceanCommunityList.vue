...
// ===== Mock 数据：10 条，混合 3:4 图 / 1:1 图 / 纯文字 =====
const mockPosts = [
  {
    id: 1,
    title: '清晨的深圳湾白鹭群',
    description: '清晨六点抵达深圳湾公园，成群的白鹭在滩涂上觅食，时而展翅掠过水面，画面非常震撼。用长焦抓拍了几张特写。',
    photoUrl: 'https://picsum.photos/seed/bird1/400/533',
    imageRatio: '3/4',
    username: '观鸟爱好者',
    avatarUrl: '',
    avatarFrame: 'ocean',
    ...
    liked: false,
    locationName: '深圳湾公园',
    createdAt: '2026-06-25 06:30',
  },
  {
    id: 2,
    title: '红树林生态速览',
    description: '在红树林保护区观察到招潮蟹和弹涂鱼的有趣互动，红树林根系间隐藏着丰富的小型生物群落。',
    photoUrl: 'https://picsum.photos/seed/mangrove/400/400',
    imageRatio: '1/1',
    username: '生态志愿者',
    avatarUrl: '',
    avatarFrame: 'gold',
  ...
  {
    id: 3,
    title: '海洋微塑料采样数据分析方法总结',
    description: '最近整理了微塑料采样的标准流程和数据分析方法。如果大家有更好的实验室分析建议欢迎讨论交流！',
    photoUrl: '',
    imageRatio: null,
    username: '环保先锋',
    avatarUrl: '',
    ...
    liked: false,
    locationName: '',
    createdAt: '2026-06-23 15:45',
  },
  {
    id: 4,
    title: '大堡礁珊瑚白化现状',
    description: '本次潜水观察记录了大堡礁南部珊瑚白化的最新情况。部分区域出现自然恢复迹象，但整体形势依然严峻。水温数据显示比历史均值高出1.8°C。',
    photoUrl: 'https://picsum.photos/seed/coral2/400/533',
    imageRatio: '3/4',
    username: '海洋守护者',
    avatarUrl: '',
    avatarFrame: 'crystal',
  ...
  },
  {
    id: 5,
    title: '分享一下我的潜水装备清单',
    description: '入门潜水三年了，整理了一份个人觉得最实用的装备清单，从面镜到潜水电脑，每件都有使用心得。',
    photoUrl: '',
    imageRatio: null,
    username: '深海旅人',
    avatarUrl: '',
  ...
  },
  {
    id: 6,
    title: '水母湖的奇幻世界',
    description: '帕劳水母湖的无毒黄金水母太美了，阳光透过湖面洒下，成千上万的水母在周围缓缓飘动。',
    photoUrl: 'https://picsum.photos/seed/jellyfish/400/400',
    imageRatio: '1/1',
    username: '水下摄影师Leo',
    avatarUrl: '',
    avatarFrame: 'rainbow',
  ...
  },
  {
    id: 7,
    title: '夜潜安全注意事项汇总',
    description: '第一次夜潜前做了大量功课，整理了灯光信号、潜伴距离控制、应急上浮等关键要点，希望帮助到同样准备夜潜的朋友。',
    photoUrl: '',
    imageRatio: null,
    username: '潜水教练Mike',
    avatarUrl: '',
  ...
  },
  {
    id: 8,
    title: '座头鲸跃出水面',
    description: '在汤加瓦瓦乌群岛拍到的座头鲸跃出水面瞬间！母鲸带着幼鲸在浅水区活动，跃出水面多达十几次。',
    photoUrl: 'https://picsum.photos/seed/whale2/400/533',
    imageRatio: '3/4',
    username: '深海旅人',
    avatarUrl: '',
    avatarFrame: 'flame',
  ...
  },
  {
    id: 9,
    title: '马尔代夫日落船潜',
    description: '黄昏时分从船尾入水，海面被夕阳染成金色。与一群蝠鲼擦肩而过，是最难忘的一次潜水体验。',
    photoUrl: 'https://picsum.photos/seed/sunset1/400/400',
    imageRatio: '1/1',
    username: '旅行日记本',
    avatarUrl: '',
    avatarFrame: 'dashed',
    ...
    liked: false,
    locationName: '马尔代夫',
    createdAt: '2026-06-18 17:30',
  },
  {
    id: 10,
    title: '海洋保护志愿者招募',
    description: '下周末在惠东双月湾有海滩清理活动，需要20名志愿者。我们会分组清理塑料垃圾并记录数据，有兴趣的请留言报名！',
    photoUrl: '',
    imageRatio: null,
    username: '海洋守护者',
    avatarUrl: '',
